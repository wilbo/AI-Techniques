...
class MovingEntity extends Entity {
	...
	public maxTurnRate: number = 6 // maximum rate (radians per second) at which this vehicle can rotate
	...
	public render(context: Context): void {
		context.drawVehicle(this.position, 6, Vector2D.angle(this.heading))
	}
}
